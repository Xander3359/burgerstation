SUBSYSTEM_DEF(chunkclean)
	...
	wait = SECONDS_TO_TICKS(300) //JUST LIKE MINECRAFT
...
/datum/controller/subsystem/chunkclean/Initialize()
	...
	wait = initial(wait)
	if(world.maxz>=1)
		wait = CEILING(wait/world.maxz,1)
...
/datum/controller/subsystem/chunkclean/on_life()
...
/datum/controller/subsystem/chunkclean/proc/process_entire_z(z)
...
/datum/controller/subsystem/proc/get_chunk_data(adjacent = FALSE)
...
/datum/controller/subsystem/proc/get_chunk(chunk_x, chunk_y, chunk_z)
