...
/datum/controller/subsystem/text/proc/check_duplicate_name(name) //For mobs.
	if(name_count[name])
		name_count[name]++
...
/datum/controller/subsystem/text/proc/check_duplicate_player_name(name, ckey) //For players.
