...
/datum/controller/subsystem/smoothing/unclog(mob/caller)
	queued_smoothing_objs.Cut()
	queued_smoothing_turfs.Cut()
	. = ..()

/datum/controller/subsystem/smoothing/Initialize()
...
/datum/controller/subsystem/smoothing/on_life()
...
/datum/controller/subsystem/smoothing/proc/queue_update_edges(turf/T, include_self = TRUE)
