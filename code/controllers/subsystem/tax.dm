...
/datum/controller/subsystem/tax/proc/can_pax_taxes(mob/living/advanced/player/P)
	return world.realtime >= (P.last_tax_payment + 604800*10) //1 week

/datum/controller/subsystem/tax/proc/check_delinquent(mob/living/advanced/player/P)
	. = world.realtime - (P.last_tax_payment + 604800*10*2) //2 weeks
	. = max(0,.)

/datum/controller/subsystem/tax/proc/pay_taxes(mob/living/advanced/player/P, silent = FALSE)
...
/datum/controller/subsystem/tax/proc/get_bracket_tax(profit)
...
/datum/controller/subsystem/tax/proc/get_tax_amount(mob/living/advanced/player/P)
...
/datum/controller/subsystem/tax/proc/get_explaination(mob/living/advanced/player/P)
