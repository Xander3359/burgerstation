...
/datum/controller/subsystem/payday/unclog(mob/caller)
	wait = -1
	. = ..()

/datum/controller/subsystem/payday/Initialize()
	next_payday = world.time + 180 SECONDS
	return ..()

/datum/controller/subsystem/payday/on_life()
...
/datum/controller/subsystem/payday/proc/trigger_payday()
