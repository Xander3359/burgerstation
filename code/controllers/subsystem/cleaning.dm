...
/datum/controller/subsystem/delete/unclog(mob/caller)
...
/datum/controller/subsystem/delete/on_life()
...
/datum/controller/subsystem/delete/proc/should_delete(datum/D)
