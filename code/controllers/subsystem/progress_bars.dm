...
/datum/controller/subsystem/progressbars/unclog(mob/caller)
...
/datum/controller/subsystem/progressbars/proc/process_progress_bar(k)
	var/atom/A = k
	var/list/progress_list = all_progress_bars[k]
	var/obj/hud/progress_bar/P = progress_list["progress_bar"]
...
/datum/controller/subsystem/progressbars/on_life()
...
/proc/add_progress_bar(atom/owner, atom/object, desired_time, desired_proc, ...)
...
/proc/add_progress_bar_conditions(atom/owner, atom/object, desired_proc, ...)
