...
/datum/controller/subsystem/enchanting/Initialize()
...
/datum/controllers/subsystem/enchanting/proc/get_random_enchantment(ench_type = ENCH_ANY, list/whitelist, list/blacklist)
