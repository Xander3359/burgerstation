...
/datum/controller/subsystem/explosion/unclog(mob/caller)
...
/datum/controller/subsystem/explosion/Initialize()
	. = ..()
	fire_particles = new/particles/fire

/datum/controller/subsystem/explosion/proc/add_data(location, owner,source, epicenter, magnitude, loyalty_tag)
...
/datum/controller/subsystem/explosion/on_life()
