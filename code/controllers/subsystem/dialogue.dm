...
/datum/controller/subsystem/dialogue/Initialize()
...
/datum/controller/subsystem/dialogue/proc/setup_combat_dialogue(combat_dialogue/CD)
...
/datum/controller/subsystem/dialogue/proc/get_combat_dialogue(combat_dialogue/cd_id, desired_category, swear_chance = 25)
