...
/datum/controller/subsystem/hook/proc/add_hook(event_name, identifier, datum/owner, datum/proc_target, proc_to_use)
...
/datum/controller/subsystem/hook/proc/remove_hook(event_name, identifier, datum/datum_to_use)
...
/datum/controller/subsystem/hook/proc/call_hook(event_name, datum/datum_to_use,args)
