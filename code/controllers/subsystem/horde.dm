...
/datum/controller/subsystem/horde/unclog(mob/caller)
	enable = FALSE
	. = ..()

/datum/controller/subsystem/horde/Initialize()
...
/datum/controller/subsystem/horde/on_life()
...
/datum/controller/subsystem/horde/proc/get_squad_to_send(atom/target)
...
/datum/controller/subsystem/horde/proc/send_squad(atom/target, mob/living/attacker_type, bypass_restrictions = FALSE, horde_count_override = 0, debug = FALSE)
