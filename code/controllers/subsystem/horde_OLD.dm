...
/datum/controller/subsystem/horse/proc/on_killed_syndicate(var/mob/living/L)
...
/datum/controller/subsystem/horse/proc/get_enemies_to_spawn()
...
/datum/controller/subsystem/horse/proc/check_hijack()
...
/datum/controller/subsystem/horse/on_life()
...
/datum/controller/subsystem/horse/proc/find_viable_target()
...
/datum/controller/subsystem/horse/proc/find_viable_spawn()
...
/datum/controller/subsystem/horse/Initialize()
	state = HORDE_STATE_WAITING
	round_time = 0
	round_time_next = HORDE_DELAY_WAIT
	return ..()

/datum/controller/subsystem/horse/proc/spawn_objectives(var/artifact_count = 1, var/kill_count = 3, var/rescue_count = 1)
...
/datum/controller/subsystem/horse/proc/queue_objectives_update()
	next_objectives_update = world.time + 30
	return TRUE

/datum/controller/subsystem/horse/proc/update_objectives()
...
//0 is neutral.
/datum/controller/subsystem/horse/proc/get_threat_level()
...
/datum/controller/subsystem/horse/proc/check_threat_level()
