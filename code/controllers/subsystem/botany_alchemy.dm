...
/datum/controller/subsystem/botany_alchemy/Initialize()
...
/datum/controller/subsystem/botany_alchemy/unclog(mob/caller)
...
/datum/controller/subsystem/botany_alchemy/on_life()
