...
/datum/controller/subsystem/admin/proc/load_permissions_from_file()
...
/datum/controller/subsystem/admin/Initialize()
...
/datum/controller/subsystem/admin/proc/sync_permissions()
