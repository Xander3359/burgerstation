...
/datum/controller/subsystem/balance/proc/process_loadout_contents(obj/O)
...
/datum/controller/subsystem/balance/proc/process_loadout(turf/T)
...
/datum/controller/subsystem/balance/proc/process_items(turf/T, list/everything_else)
...
/datum/controller/subsystem/balance/proc/process_bullets(turf/T, list/bullet_subtypes)
	. = list()
...
/datum/controller/subsystem/balance/proc/process_magazines(turf/T, list/magazine_subtypes)
	. = list()
...
/datum/controller/subsystem/balance/proc/process_weapons(turf/T, list/weapon_subtypes)
	. = list()
...
/datum/controller/subsystem/balance/Initialize()
