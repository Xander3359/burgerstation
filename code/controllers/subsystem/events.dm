...
/datum/controller/subsystem/events/unclog(mob/caller)
...
/datum/controller/subsystem/events/proc/process_event(event/E)
...
/datum/controller/subsystem/events/on_life()
...
/datum/controller/subsystem/events/proc/trigger_random_event(minor)
...
/datum/controller/subsystem/events/proc/trigger_event(event/E)
