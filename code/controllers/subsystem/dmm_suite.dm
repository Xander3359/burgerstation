...
/datum/controller/subsystem/dmm_suite/Initialize()
...
/datum/controller/subsystem/dmm_suite/proc/is_pvp_coord(x, y, z, distance = 0)
...
/*
/datum/controller/subsystem/dmm_suite/proc/generate_world(z = 0)
