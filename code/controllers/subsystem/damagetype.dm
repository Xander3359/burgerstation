...
/*
/datum/controller/subsystem/damagetype/proc/add_damage(atom/attacker,atom/victim,atom/weapon,atom/hit_object,atom/blamed,damage_multiplier=1,damagetype/DT)
