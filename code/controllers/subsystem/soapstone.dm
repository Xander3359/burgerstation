...
/datum/controller/subsystem/soapstone/Initialize()
	save_soapstone = new
	save_soapstone.quick_load()
	return ..()

/datum/controller/subsystem/soapstone/proc/create_new_soapstone(turf/desired_loc, desired_dir, desired_color, desired_owner, desired_ckey, desired_text, desired_date, desired_time)
